...
export class IndividualchatPage {
	...
	person;
	individualChat: FirebaseListObservable<any>;
	private message: any;
  ...
  //   }).then((individualChat) => {
  //   	this.individualChat = af.database.list('/Weddings/' + this.currentWeddingKey + '/individualChats/' + this.group.groupId + '/groupChat', {
  //   		query: {
  //   			limitToLast: 10
  //   		}
  //   	});
